...
| 秦川机床 | 000837 | 丝杠/机床/精密加工；丝杠和精密机床是运动执行链的重要配套，弹性取决于机器人业务直接暴露 | 2026一季报营收11.44亿，同比9.64%；归母净利2426.68万，同比-11.71% | 现价10.62，PE 218.74，PB 2.21；券商远期PE中位数106.98 | 宽幅震荡，需突破确认；MA5/10/20/60=NA/NA/NA/NA；20日箱体NA-NA，60日箱体NA-NA；箱体位置NA%；量能数据不足；趋势分0.0/5 | 数据不足，暂不设买点 | 数据不足；产业证据失效：保留为关键技术突破者，需继续核验收入占比和客户名单 | EPS锚0.19；100/140/180x情景价 19.00/26.60/34.20；压力位 数据不足 | 观察名单，等待结构修复 |
| 鸣志电器 | 603728 | 电机/控制；电机与运动控制是机器人执行单元的重要环节，壁垒低于减速器但应用广 | 2026一季报营收7.00亿，同比17.65%；归母净利1381.71万，同比92.19% | 现价59.65，PE 368.77，PB 8.43；券商远期PE中位数159.37 | 宽幅震荡，需突破确认；MA5/10/20/60=NA/NA/NA/NA；20日箱体NA-NA，60日箱体NA-NA；箱体位置NA%；量能数据不足；趋势分0.0/5 | 数据不足，暂不设买点 | 数据不足；产业证据失效：保留为重要配套，需验证人形机器人订单和收入弹性 | EPS锚0.52；100/140/180x情景价 52.00/72.80/93.60；压力位 数据不足 | 观察名单，等待结构修复 |
