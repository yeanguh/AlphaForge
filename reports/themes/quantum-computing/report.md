...
| --- | --- | --- | --- | --- | --- | --- |
| 高弹性二线 | 中科曙光 | 603019 | 算法/云平台 | 配套/相邻链路；财务增速可见；风险收益比2.96；PE 68.6 | 订单/客户认证/收入占比/政策或监管里程碑出现公告级证据 | 商业化ROI不足、客户验证低于预期、收入暴露不足或监管约束增强 |
