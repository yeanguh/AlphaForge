...
第一类是**主线卡口候选**。绿的谐波对应机器人核心零部件里的精密传动方向，逻辑上更接近上游卡口。但它当前的市场状态并不友好：PE 529.43、PB 20.29，涨跌幅 1.00%。这不是“热度确认”，反而是一个很好的反证样本：如果订单和收入暴露跟不上，高估值会先变成压力。也就是说，卡口资产不是不能贵，而是贵必须有更硬的兑现线索。
